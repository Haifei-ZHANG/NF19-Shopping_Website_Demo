...
<div class="checkout">
	<div class="container">
		<h2>Votre liste des envues</span></h2>
<?php
	if(!isset($_SESSION['userType'])){
		die();
	}
...
$vSql="select p.référence,p.nom,p.prix,p.prixpromo,p.deuxsouscatégorie from listeEnvie l, produit p where l.acheteur = '$userEmail' and p.référence = l.produit;";
...
// on ajoute bouton qui permet de supprimer le produit
		echo "<td class=\"invert\">
				<a href='listenviesupprimer.php?pref=$produitref' class=\"fa fa-times\"></td>
				</tr>";
	}
echo "				</table>
			</div>";
